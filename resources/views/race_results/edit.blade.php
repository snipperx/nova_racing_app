    ...
    <div class="am-mainpanel row justify-content-center">
        <div class="am-pagebody col-md-10">
            ...
            <div class="card pd-20 pd-md-40 mg-t-50 ">
                <h6 class="card-body-title">Edit Race Results</h6>

                <form id="edit-results-form" class="form-horizontal" action="{{ route('race-results.update', $raceResult->id) }}">
                    @csrf
                    {{--                    @method('PUT')--}}
                                    ...
                                    <div class="row mg-t-20">
                                        ...
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <input type="number" class="form-control"
                                                   name="podium_position" value="{{ $raceResult->podium_position ?? '' }}"
                                    ...
                                    <div class="row mg-t-20">
                                        ...
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <input type="text" class="form-control"
                                                   name="race_time" value="{{ $raceResult->race_time ?? '' }}"
                                        ...
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <select class="form-control select2" name="team_id" data-placeholder="Choose one">
                                                ...
                                                @foreach($teams as $team)
                                                    <option value="{{ $team->id }}" {{ $team->id == $raceResult->team_id ? 'selected' : '' }}>
                                                        {{ $team->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <select class="form-control select2" name="driver_id" data-placeholder="Choose one">
                                                ...
                                                @foreach($drivers as $driver)
                                                    <option value="{{ $driver->id }}" {{ $driver->id == $raceResult->driver_id ? 'selected' : '' }}>
                                                        {{ $team->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <select class="form-control select2" name="race_details_id" data-placeholder="Choose one">
                                                ...
                                                @foreach($race_details as $race_detail)
                                                    <option value="{{ $race_detail->id }}" {{ $race_detail->id == $raceResult->race_details_id ? 'selected' : '' }}>
                                                        {{ $race_detail->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row row-xs mg-t-30">
                                        <div class="col-lg-8 mg-l-auto">
                                            <div class="form-layout-footer d-flex justify-content-end">
                                                <button id="edit-results-btn" class="btn btn-info mg-r-5 ml-auto">Submit
                                                    Form
                                                </button>
...
@section('page_script')
    ...
    <script>
        $(function () {
            ...
            $('#edit-results-btn').on('click', function () {
                event.preventDefault();
                console.log('clicked')
                const form = $('#edit-results-form');
