    ...
    <div class="am-mainpanel row justify-content-center">
        <div class="am-pagebody col-md-10">
            ...
            <div class="card pd-20 pd-md-40 mg-t-50">
                <h6 class="card-body-title">Create a new Driver</h6>
                <form id="add-drivers-form" class="form-horizontal" action="{{ route('driver.store') }}"
                                    ...
                                    <div class="row row-xs mg-t-30">
                                        <div class="col-lg-8 mg-l-auto">
                                            <div class="form-layout-footer d-flex justify-content-end">
                                                <button id="add-drivers-btn" class="btn btn-info mg-r-5 ml-auto">Submit
                                                    Form
                                                </button>
...
@section('page_script')
    ...
    <script>
        $(function () {
            ...
            $('#add-drivers-btn').on('click', function () {
                event.preventDefault();
                const form = $('#add-drivers-form');
                let redirectUrl = '{{ route('driver.index') }}';
                let formMethod = 'POST';
                handleDriverAddEvent(form, redirectUrl, formMethod)
            });
