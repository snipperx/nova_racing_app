    ...
    <div class="am-mainpanel row justify-content-center">
        <div class="am-pagebody col-md-10">
            ...
            <div class="card pd-20 pd-md-40 mg-t-50">
                <h6 class="card-body-title">Create a new Qualifying Session</h6>
                <form id="add-qualifying-form" class="form-horizontal" action="{{ route('qualifying-sessions.store') }}">
                    @csrf
                                ...
                                <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                                    ...
                                    <div class="row mg-t-20">
                                        ...
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <input type="number" class="form-control" name="qualifying_position"
                                    ...
                                    <div class="row row-xs mg-t-30">
                                        <div class="col-lg-8 mg-l-auto">
                                            <div class="form-layout-footer d-flex justify-content-end">
                                                <button id="add-qualifying-btn" class="btn btn-info mg-r-5 ml-auto">Submit Form</button>
...
@section('page_script')
    ...
    <script>
        $(function () {
            ...
            $('#add-qualifying-btn').on('click', function () {
                event.preventDefault();
                const form = $('#add-qualifying-form');
