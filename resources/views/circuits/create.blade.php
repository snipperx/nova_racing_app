    ...
    <div class="am-mainpanel row justify-content-center">
        <div class="am-pagebody col-md-10">
            ...
            <div class="card pd-20 pd-md-40 mg-t-50">
                <h6 class="card-body-title">Create a new Team</h6>
                <form id="add-circuit-form" class="form-horizontal" action="{{ route('circuit.store') }}">
                    @csrf
                                ...
                                <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                                    ...
                                    <div class="row mg-t-20">
                                        <label class="col-sm-4 form-control-label">circuit Lap Record: <span
                                                class="tx-danger">*</span></label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <input type="text" class="form-control" name="lap_record"
                                                   placeholder="Enter lap record">
                                        </div>
                                    </div>

{{--                                    <div class="row mg-t-20">--}}
{{--                                        <label class="col-sm-4 form-control-label">image: <span--}}
{{--                                                class="tx-danger">*</span></label>--}}
{{--                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">--}}
{{--                                            <input type="text" class="form-control" name="location"--}}
{{--                                                   placeholder="Enter location">--}}
                                    ...
                                    <div class="row row-xs mg-t-30">
                                        <div class="col-lg-8 mg-l-auto">
                                            <div class="form-layout-footer d-flex justify-content-end">
                                                <button id="add-circuit-btn" class="btn btn-info mg-r-5 ml-auto">Submit Form</button>
...
@section('page_script')
    ...
    <script>
        $(function () {
            ...
            $('#add-circuit-btn').on('click', function () {
                event.preventDefault();
                const form = $('#add-circuit-form');
