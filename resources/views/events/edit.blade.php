    ...
    <div class="am-mainpanel row justify-content-center">
        <div class="am-pagebody col-md-10">
            ...
            <div class="card pd-20 pd-md-40 mg-t-50 ">
                <h6 class="card-body-title">Edit Events</h6>

                <form id="edit-event-form" class="form-horizontal" action="{{ route('events.update', $event->id) }}">
                    @csrf
{{--                    @method('PUT')--}}
                                        ...
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <select class="form-control select2" name="circuit_id"
                                                ...
                                                @foreach($circuits as $circuit)
                                                    <option value="{{ $circuit->id }}" {{ $circuit->id == $event->circuit_id ? 'selected' : '' }}>
                                                        {{ $circuit->name }}
                                                    </option>
                                                @endforeach
                                            </select>
