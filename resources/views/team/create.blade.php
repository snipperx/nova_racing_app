    ...
    <div class="am-mainpanel row justify-content-center">
        <div class="am-pagebody col-md-10">
            ...
            <div class="card pd-20 pd-md-40 mg-t-50">
                ...
                <form id="add-teams-form" class="form-horizontal" action="{{ route('teams.store') }}">
                    @csrf
                                ...
                                <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                                    ...
                                    <div class="row mg-t-20">
                                        <label class="col-sm-4 form-control-label">Event: <span
                                                class="tx-danger">*</span></label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <select class="form-control select2" name="event_id" data-placeholder="Choose one">
                                    ...
                                    <div class="row row-xs mg-t-30">
                                        <div class="col-lg-8 mg-l-auto">
                                            <div class="form-layout-footer d-flex justify-content-end">
                                                <button id="add-teams-btn" class="btn btn-info mg-r-5 ml-auto">Submit Form</button>
...
@section('page_script')
    ...
    <script>
        $(function () {
            ...
            $('#add-teams-btn').on('click', function () {
                event.preventDefault();
                const form = $('#add-teams-form');
